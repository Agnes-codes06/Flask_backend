...
# extracting user input from a form (request from imsomnia or frontend)
def signup():
    ...
    # define our data (what we want to pass,placeholders)
    data=(username,password,email,phone)

    # execute data(perform the query)
...
def addproducts():
    ...
    # extracting product details from form
    product_name=request.form["product_name"]
    product_description=request.form["product_description"]
    product_cost=request.form["product_cost"]
    product_photo=request.files["product_photo"]

    # extracting the file name from product photo
    filename=product_photo.filename

    # specify the path to our static folder that contains images folder(save image to folder and image name to database)
    ...
    #sql query(add new product into product_details table)
    ...
    # save the products
    connection.commit()
    return jsonify({"message":"product details uploaded successfully"})
...
def getproductdetails():
    ...
    # fetch the product from thr database
